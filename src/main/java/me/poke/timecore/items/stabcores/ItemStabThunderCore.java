...
public class ItemStabThunderCore extends Item {

	public ItemStabThunderCore(){
		setUnlocalizedName(Reference.WeatherControlItems.STAB_THUNDER_CORE.getUnlocalizedName());
		setRegistryName(Reference.WeatherControlItems.STAB_THUNDER_CORE.getRegistryName());
